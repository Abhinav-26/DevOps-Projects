...
In Job-2's execute shell write,<br>
  <code>if sudo docker container ls | grep production<br>
    then<br>
    sudo docker conatiner rm -f production<br>
    else<br>
    sudo docker dun -dit -p 8081:80 -v/name_of_your_WorkspaceFolder:/usr/local/apache2/htdocs --name production httpd<br>
    fi</code>
